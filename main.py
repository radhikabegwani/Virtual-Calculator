...
cap.set(3,1280) #changing the width of image
cap.set(4,720) #changing the height
        ...
        if length<50:
            for i, button in enumerate(buttonList):
               if button.checkClick(x,y) and delayCounter == 0:
                   myValue = buttonListValues[int(i%4)][int(i/4)] #column & row for ex 7... 7%4 = 3 =>column & 7/4=1+>row
                   if myValue == "=":
